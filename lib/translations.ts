  ...
  pl: {
    ...
    comparison: {
      ...
      benefits: [
        ...
        "Stała cena 50 zł/msc — zero prowizji, zero ukrytych opłat",
    ...
    antiPlatform: {
      ...
      keyHeadline: "Inwestujesz 50 zł, odzyskujesz ponad 2 500 zł miesięcznie",
      keyText: "Przy rachunku 200 zł platforma dostawcza zabiera Ci 40–60 zł prowizji. ChefVision kosztuje 50 zł miesięcznie — bez prowizji, bez tabletów, bez utraty klientów. Kelnerzy odzyskują czas, goście zamawiają śmielej, a Ty zbierasz opinie w Google za 1,50 zł.",
    },
    profitMath: {
    ...
    cta: {
      ...
      startPlan: {
        ...
        currency: "zł / miesiąc",
        label: "Start",
        desc: "Wszystko, czego potrzebujesz, aby stworzyć profesjonalne cyfrowe menu i lepiej obsługiwać gości.",
        buyBtn: "Wybieram Start",
        features: [
      ...
      regular: {
        ...
        currency: "zł / miesiąc",
        label: "Premium",
        desc: "Dla restauracji i hoteli, które chcą zapewnić gościom pełniejsze doświadczenie i wykorzystać więcej możliwości ChefVision.",
      ...
      lifetimePlan: {
        badge: "Oferta specjalna — tylko 10 kont",
        price: "299",
        currency: "zł / rok",
        billing: "Jedna płatność za 12 miesięcy",
        priceLockNote: "Zachowujesz cenę 299 zł rocznie przy kolejnych nieprzerwanych odnowieniach.",
        limitedNote: "Tylko 10 kont w tej ofercie",
        compareMonthly: "Premium miesięcznie: 50 zł × 12 = 600 zł / rok",
        compareAnnual: "Plan Roczny: 299 zł / rok",
        savings: "Oszczędzasz 301 zł w pierwszym roku",
        label: "Plan Roczny",
        desc: "Pełny dostęp do planu Premium przez 12 miesięcy w specjalnej cenie dla pierwszych 10 klientów ChefVision.",
        buyBtn: "Wybieram Plan Roczny",
        features: [
          "Wszystko z planu Premium",
          "12 miesięcy pełnego dostępu",
          "Jedna płatność za cały rok",
          "Gwarancja ceny 299 zł / rok przy kolejnych nieprzerwanych odnowieniach",
          "Dostęp do nowych funkcji Premium w okresie aktywnego planu",
          "100 tokenów AI",
        ],
        renewalNote:
          "Cena 299 zł / rok pozostaje niezmienna przy kolejnych odnowieniach, o ile plan jest odnawiany bez przerwy. Po rezygnacji i późniejszym ponownym zakupie obowiązuje aktualna cena oferty.",
      },
      menuService: {
  ...
  en: {
    ...
    comparison: {
      ...
      benefits: [
        ...
        "Fixed price €12/mo — zero commission, zero hidden fees",
    ...
    antiPlatform: {
      ...
      keyHeadline: "Invest €12, recover over €580/month",
      keyText: "On a €46 bill, a delivery platform takes €7–14 in commission. ChefVision charges €12/month — no commission, no tablets, no lost customers. Waiters reclaim time, guests order more confidently, and you collect Google reviews for €0.35.",
    },
    profitMath: {
    ...
    cta: {
      ...
      startPlan: {
        ...
        currency: "PLN / month",
        label: "Start",
        desc: "Everything you need to create a professional digital menu and serve guests better.",
        buyBtn: "Choose Start",
        features: [
      ...
      regular: {
        ...
        currency: "PLN / month",
        label: "Premium",
        desc: "For restaurants and hotels that want a fuller guest experience and more ChefVision capabilities.",
      ...
      lifetimePlan: {
        badge: "Special offer — only 10 accounts",
        price: "299",
        currency: "PLN / year",
        billing: "One payment for 12 months",
        priceLockNote: "You keep the 299 PLN yearly price on continuous renewals.",
        limitedNote: "Only 10 accounts in this offer",
        compareMonthly: "Premium monthly: 50 PLN × 12 = 600 PLN / year",
        compareAnnual: "Annual plan: 299 PLN / year",
        savings: "You save 301 PLN in the first year",
        label: "Annual Plan",
        desc: "Full access to the Premium plan for 12 months at a special price for the first 10 ChefVision customers.",
        buyBtn: "Choose Annual Plan",
        features: [
          "Everything from the Premium plan",
          "12 months of full access",
          "One payment for the whole year",
          "Price lock at 299 PLN / year on continuous renewals",
          "Access to new Premium features during an active plan",
          "100 AI tokens",
        ],
        renewalNote:
          "The 299 PLN / year price stays unchanged on renewals as long as the plan is renewed without a break. After cancellation and a later repurchase, the current offer price applies.",
      },
      menuService: {
        badge: "Team service",
        price: "299",
