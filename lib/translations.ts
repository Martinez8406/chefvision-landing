  ...
  pl: {
    ...
    cta: {
      ...
      lifetimePlan: {
        ...
        priceLockNote: "Cena Founder na kolejne lata: 599 zł / rok",
        limitedNote: "Tylko 10 kont w tej cenie",
        label: "Founder Annual",
        desc: "Pełny dostęp do ChefVision Premium przez 12 miesięcy za 599 zł. Jako jeden z pierwszych 10 klientów zachowujesz cenę 599 zł rocznie przy kolejnych odnowieniach, pod warunkiem nieprzerwanego odnawiania planu.",
        buyBtn: "Zabezpiecz cenę Founder",
        features: [
          "Wszystko z planu Premium",
          "12 miesięcy pełnego dostępu do ChefVision",
          "599 zł za cały rok zamiast miesięcznego abonamentu",
          "Gwarancja ceny Founder — 599 zł / rok przy kolejnych nieprzerwanych odnowieniach",
          "Dostęp do nowych funkcji Premium dodawanych w okresie aktywnego planu",
          "100 tokenów AI na poprawianie zdjęć dań i tworzenie profesjonalnego tła. Tokeny przyznawane zgodnie z obecną logiką planu Founder.",
        ],
        renewalNote:
          "Cena Founder 599 zł / rok pozostaje niezmienna przy kolejnych odnowieniach, o ile plan jest odnawiany bez przerwy. W przypadku rezygnacji i późniejszego ponownego zakupu obowiązuje aktualna cena oferty.",
      },
      menuService: {
    ...
    cta: {
      ...
      startPlan: {
        ...
        features: [
          ...
          "Message to the manager from the menu — before a guest leaves a negative Google review",
        ],
      },
      regular: {
        badge: "Most popular",
      ...
      lifetimePlan: {
        badge: "Only 10 accounts at this price",
        price: "599",
        currency: "PLN / year",
        billing: "one payment for 12 months",
        priceLockNote: "Founder price for following years: 599 PLN / year",
        limitedNote: "Only 10 accounts at this price",
        label: "Founder Annual",
        desc: "Full access to ChefVision Premium for 12 months for 599 PLN. As one of the first 10 customers, you keep the 599 PLN yearly price on renewals — as long as you renew without interruption.",
        buyBtn: "Lock in Founder price",
        features: [
          "Everything from the Premium plan",
          "12 months of full access to ChefVision",
          "599 PLN for the whole year instead of a monthly subscription",
          "Founder price lock — 599 PLN / year on continuous renewals",
          "Access to new Premium features added during an active plan",
          "100 AI tokens for improving dish photos and creating professional backgrounds. Tokens are granted according to the current Founder plan logic.",
        ],
        renewalNote:
          "The Founder price of 599 PLN / year stays unchanged on renewals as long as the plan is renewed without a break. If you cancel and buy again later, the current offer price applies.",
      },
      menuService: {
        badge: "Team service",
        price: "299",
