...
export const hoteleContent: Record<"pl" | "en" | "hr", HoteleCopy> = {
  pl: {
    ...
    hub: {
      ...
      alt1: "Hotel Hub ChefVision — główny ekran z informacjami o hotelu i Room Service",
  ...
  en: {
    ...
    hub: {
      ...
      alt1: "ChefVision Hotel Hub — main screen with hotel information and Room Service",
  ...
  hr: {
    ...
    hub: {
      ...
      alt1: "ChefVision Hotel Hub — glavni zaslon s informacijama o hotelu i Room Service",
