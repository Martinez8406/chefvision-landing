      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="max-w-6xl mx-auto mt-10 rounded-2xl border border-border bg-background shadow-lg shadow-black/5 overflow-hidden">
          <div className="bg-primary px-6 py-4 flex items-center justify-center gap-3">
            ...
            <p className="text-sm font-semibold text-primary-foreground text-center">{c.freeBanner}</p>
          </div>
          ...
          <div className="p-6 sm:p-8">
            ...
            <div className="border-t border-border pt-8 mb-8">
              <div className="space-y-3 mb-6 max-w-3xl">
                <p className="text-sm font-semibold text-foreground leading-relaxed">{c.pricingIntro1}</p>
                <p className="text-sm text-muted-foreground leading-relaxed">{c.pricingIntro2}</p>
              </div>
