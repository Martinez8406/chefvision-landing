...
const content = {
    ...
    steps: [
      {
        ...
        description: "Krótkie wideo z przygotowania dania — wystarczy telefon. Bez sprzętu, bez studia. Autentyczność jest tu największą wartością.",
      },
      {
        number: "02",
        title: "Podpinasz link do dania",
        description: "W panelu ChefVision do każdej pozycji w menu dodajesz link do YouTube, TikToka lub Instagrama. Jeden klik — gotowe.",
      },
      {
        number: "03",
        title: "Gość skanuje QR i zagląda za kulisy",
        description: "Przeglądając menu, gość widzi ikonę wideo przy daniu. Klika i w sekundę ogląda, jak jego potrawa powstaje w Twojej kuchni.",
      },
      {
        number: "04",
        title: "Budujesz więź, której nie kupisz za pieniądze",
        description: "Gość, który widział Twoje ręce przy pracy, nie jest już anonimowym klientem. Jest kimś, kto zna Twoją historię.",
      },
    ],
  ...
  en: {
    ...
    steps: [
      {
        number: "01",
        title: "You film in the kitchen",
        description: "A short video of dish preparation — just your phone. No equipment, no studio. Authenticity is the greatest value here.",
      },
      {
        number: "02",
        title: "You attach the link to the dish",
        description: "In the ChefVision panel, you add a YouTube, TikTok or Instagram link to any menu item. One click — done.",
      },
      {
        number: "03",
        title: "Guest scans QR and goes behind the scenes",
        description: "While browsing the menu, the guest sees a video icon next to the dish. They click and instantly watch how their meal is made in your kitchen.",
      },
      {
        number: "04",
        title: "You build a bond that money can't buy",
        description: "A guest who has seen your hands at work is no longer an anonymous customer. They are someone who knows your story.",
      },
    ],
    ...
    stats: [
      {
        ...
        desc: "Video next to a dish makes guests spend 3 times longer browsing the menu.",
      },
      {
        stat: "100%",
        label: "authenticity",
        desc: "No delivery platform will show your customers inside your kitchen. Only you can do that.",
      },
      {
        stat: "€0",
        label: "extra cost",
        desc: "All you need is a phone and a YouTube, TikTok or Instagram account. You attach the link in the panel in seconds.",
      },
    ],
  },
}
